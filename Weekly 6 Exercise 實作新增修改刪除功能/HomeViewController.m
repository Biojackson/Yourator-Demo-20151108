...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItems = @[searchButton, bookmarksButton];
    
    
    [self.tableView reloadData];
}
//addButton = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(addButPressed)];

-(void)addButPressed { //為什麼這邊不用:(id)sender??????
